...
function headerchange(check) {
    if (check == 1) {
        ...
        var img = document.getElementById('homaj-css').src = "../images/login/css-hover.png";
    } else if (check == 5) {
...
function headerorigin(check) {
    if (check == 1) {
        ...
        var img = document.getElementById('homaj-css').src = "../images/login/css.png";
    } else if (check == 5) {
